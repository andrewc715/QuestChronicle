...
Quest Chronicle records a character's quest journey, builds zone-aware outfit concepts, and exports verified Custom Sets. Version 1.9.0a2 preserves the calibrated Traveler Cohesion instrumentation while making the automatic login wardrobe refresh cooperative and eliminating duplicate full-cache metadata passes. Traveler generation remains identical to the validated v1.8.5 baseline.
