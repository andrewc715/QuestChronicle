#!/usr/bin/env python3
"""Fail when a Quest Chronicle Lua source file exceeds the project line limit."""
...
if violations:
    print(f"FAIL: {len(violations)} Lua file(s) exceed {LIMIT} lines:")
...
print(f"PASS: every Lua file is at or below {LIMIT} lines.")
