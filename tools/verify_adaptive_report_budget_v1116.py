#!/usr/bin/env python3
"""Verify the v1.11.9 adaptive diagnostic-budget persistence contract."""
...
if failed:
    print("FAIL v1.11.9 adaptive diagnostic-budget verifier:")
    for name in failed:
        print(f"- {name}")
    sys.exit(1)
print(f"PASS v1.11.9 adaptive diagnostic-budget verification: {len(checks)} checks")
