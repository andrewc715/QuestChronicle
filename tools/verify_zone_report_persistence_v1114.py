#!/usr/bin/env python3
"""Verify the v1.11.5 Zone diagnostic-persistence repair and protected scope."""
...
checks = {
    "numeric v1.11.5 metadata": version == "1.11.5" and "## Version: 1.11.5" in toc,
...
if failed:
    print("FAIL: v1.11.5 Zone report persistence guard failed:")
    for name in failed:
        print(f"  - {name}")
    sys.exit(1)
print(f"PASS: v1.11.5 Zone report persistence verification: {len(checks)} checks")
