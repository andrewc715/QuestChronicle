...
local sources = {
    ...
    ONE_HAND = { sourceID = 4, visualID = 14, itemID = 104, styleName = "Ice-Pitted Blade", categoryID = 4 },
    OFF_HAND = { sourceID = 4, visualID = 14, itemID = 104, styleName = "Ice-Pitted Blade", categoryID = 4 },
}
...
local job = {
    ...
    anchorStats = { poolSizes = { CHEST = 47, LEGS = 32, SHOULDER = 32 }, expansions = { CHEST = 47, LEGS = 1024, SHOULDER = 1024 }, retained = { CHEST = 32, LEGS = 32, SHOULDER = 32 }, weaponBundles = 4, chosenRank = 1, shortlistSize = 4, chosenScore = 148.6, meanPairCohesion = 0.614, hardClashes = 0, pairCacheHits = 1120, pairCacheMisses = 1964 },
}
local performance = {
...
assert(#report.warnings >= 1 and report.warnings[1].key == "SEVERE_PERFORMANCE_STEP", "severe performance should be flagged")
