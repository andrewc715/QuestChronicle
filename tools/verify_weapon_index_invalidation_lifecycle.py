#!/usr/bin/env python3
"""Verify v1.11.9 weapon-index invalidation lifecycle wiring and scope."""
...
checks = {
    "v1.11.9 metadata": version == "1.11.9" and "## Version: 1.11.9" in toc,
...
print(f"PASS: v1.11.9 weapon-index invalidation lifecycle verification: {len(checks)} checks")
