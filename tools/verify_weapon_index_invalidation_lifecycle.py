#!/usr/bin/env python3
"""Verify v1.10.0 weapon-index invalidation lifecycle wiring and scope."""
...
checks = {
    "v1.10.0 metadata": version == "1.10.0" and "## Version: 1.10.0" in toc,
...
print(f"PASS: v1.10.0 weapon-index invalidation lifecycle verification: {len(checks)} checks")
