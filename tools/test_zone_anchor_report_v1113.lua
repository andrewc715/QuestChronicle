...
local report = {
    version = "1.11.3", timestamp = 1, timestampText = "2026-08-06 08:00:00",
...
}) do assert(text:find(expected, 1, true), "missing v1.11.3 Zone policy report text: " .. expected) end
print("PASS v1.11.3 Zone report: policy decomposition, legacy support boundary, weapon dedup, and performance")
