...
require("StepSourceEraEvidenceWork(work, 1000000)" not in era, "v1.11.9 million-step era drain survived")
...
print("PASS v1.11.9 era execution boundary: explicit modes, nested eligibility, no eager synchronous getter, and no million-step drain")
