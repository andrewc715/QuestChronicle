...
checks = {
    ...
    "time budget retained": "GENERATION_TIME_BUDGET_MS = 5.5" in worker,
    ...
    "generation uses cooperative era work": "StepSourceEraEvidenceWork" in (ROOT / "Core/Wardrobe/AnchorSkeletonWorker.lua").read_text(encoding="utf-8"),
