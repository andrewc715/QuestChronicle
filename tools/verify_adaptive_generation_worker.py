...
checks = {
    ...
    "time checked after operations": "NowMilliseconds() - stepStarted >= P.GENERATION_TIME_BUDGET_MS" in worker,
    ...
    "eligibility accepts precomputed era evidence": "resolvedEraEvidence" in scoring,
