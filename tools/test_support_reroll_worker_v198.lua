...
for _, phase in ipairs({ "rerollLaunchManifest", "rerollAnchorSnapshotReuse", "rerollStateMaterialization", "rerollDiagnosticIdentity", "rerollAnchorSummary", "rerollStyleContextInit", "rerollStyleContextSeed", "rerollEligibilityContext", "rerollSupportSummaryFoundation", "rerollCacheSummaryFoundation", "rerollProfileReuse", "rerollLedgerReconstruction", "rerollFixedContextCommitments", "rerollCandidatePreparation", "rerollSourceValidation", "rerollEligibility", "rerollCandidateScoring", "rerollNeighborScoring", "rerollBridgeScoring", "rerollBudgetEvaluation", "rerollShortlistSelection", "rerollStateCommit" }) do
