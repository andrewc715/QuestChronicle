#!/usr/bin/env python3
"""Verify the v1.11.3 Zone export-fidelity and applicability contract."""
...
checks = {
    "clean numeric metadata": version == "1.11.3" and "## Version: 1.11.3" in toc,
...
if failed:
    print("FAIL: v1.11.3 Zone diagnostic-fidelity guard failed:")
    for name in failed:
        print("  -", name)
    raise SystemExit(1)
print(f"PASS: v1.11.3 Zone diagnostic fidelity verification: {len(checks)} checks")
