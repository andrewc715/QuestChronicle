...
function T.GetTravelerEchoSupport(entry, entries)
    ...
    for _, other in ipairs(entries or {}) do
        if other ~= entry then
            ...
            support = support + ((other.descriptor and (other.descriptor.echoPalette or other.descriptor.palette) and (other.descriptor.echoPalette or other.descriptor.palette)[accent]) or 0) * visibility
        end
    end
